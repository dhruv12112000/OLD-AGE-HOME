            ...
            <Route exact path="/">
              {
                <>
                  ...
                  <div style={jumbotron} bg="light">
                    ...
                    <p>Animal NGO is founded by visionaries who felt the need
                      to build a free of cost medical facility for the stray
                      animals where the best, most advanced, ethical and
                      highly skilled medical care is readily available.</p>
                    <hr className="my-4" />
                    <a className="btn btn-success btn-lg" href="https://rzp.io/l/9qZJbg5" role="button">Donate</a>
                  </div>
